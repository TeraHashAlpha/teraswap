  ...
  return (
    <>
      ...
      <P>
        ...
        please contact us at <span className="text-cream-65 font-medium">legal@teraswap.app</span>.
      </P>
    </>
  )
}
  ...
  return (
    <>
      ...
      <P>
        ...
        at <span className="text-cream-65 font-medium">legal@teraswap.app</span>.
      </P>
    </>
  )
}
