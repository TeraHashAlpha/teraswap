...
export default function Footer() {
  ...
  return (
    <footer className="relative z-[1] flex flex-wrap items-center justify-center gap-x-3 gap-y-1 border-t border-cream-08 px-4 py-4 text-[11px] text-cream-35">
      ...
      <a href="https://github.com/TeraHashAlpha/teraswap" target="_blank" rel="noopener noreferrer" className="text-cream-50 transition hover:text-cream">GitHub</a>
      <span className="text-cream-15">|</span>
      <a href="https://x.com/TeraHash" target="_blank" rel="noopener noreferrer" className="text-cream-50 transition hover:text-cream" aria-label="X (Twitter)">
      ...
      <span className="text-cream-15">|</span>
      <Link href="/privacy" className="text-cream-50 transition hover:text-cream">Privacy</Link>
      <span className="text-cream-15">|</span>
      <Link href="/terms" className="text-cream-50 transition hover:text-cream">Terms</Link>
      <span className="text-cream-15">|</span>
